...
.form-group input[type="text"], .form-group input[type="number"],
	...
	border: 1px solid #ccc;
	border-radius: 4px;
	box-sizing: border-box; /* 내부 padding, border 포함한 크기 계산 */
}

/* 버튼 스타일 */
.button-style input[type="submit"] {
	padding: 10px 20px;
	background-color: #67625D; /* 버튼 배경색 */
	color: #67625d; /* 버튼 텍스트 색상 */
	border: none;
	border-radius: 4px;
	cursor: pointer;
...
.container {
        max-width: 600px;
        margin: 0 auto; /* 중앙 정렬을 위해 자동 마진 사용 */
        padding: 20px;
        background-color: #f0f0f0; /* 배경색 */
    }
			...
			<body>
				...
				<div class="container">
					<form action="addProduct" method="post">
						...
						<div class="form-group">
							<label for="like">좋아요:</label> <input type="number" name="like"
								required>
						</div>

						<div class="form-group">
							<label for="review">리뷰:</label> <input type="number"
						...
						<input type="submit" class="button-style" value="상품 추가">
					</form>
<br/><br/>
				</div>
				<!--new_footer-->
