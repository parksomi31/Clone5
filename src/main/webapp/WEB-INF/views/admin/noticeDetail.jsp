				...
				<div class="w1200">
					<div class="notice_list_view">
						<div class="view_header">
							...
							<input type="hidden" name="notice_index" value="${noticeDetail.notice_index}">
							<p class="subject">${noticeDetail.notice_title}</p>
							<p class="date">${noticeDetail.input_time}</p>
						</div>
						<div class="view_con">
							<!-- .text_box 텍스트 영역 -->
