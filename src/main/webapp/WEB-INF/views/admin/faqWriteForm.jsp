						...
						<div class="faq_nav">
							<div class="inner_box">
								<form id="searchForm" name="searchForm"
									action="/kr/ko/cs/faq/order" onsubmit="return false;">
									<div class="search">
										<div class="box01">
								...
								<div class="nav_list">
									<ul class="list">
										...
										<li class="item on"><a href="/kr/ko/cs/faq/order"
									...
									<form action="faqWrite" method="post">
										...
										<tr>
											...
											<td style="padding: 10px;"><input type="text"
												name="faq_title" size="50"
												style="width: 100%; padding: 5px;"></td>
										</tr>
										<tr>
											<td
												style="font-weight: bold; font-size: 16px; width: 30%; padding: 10px; text-align: center;">내용</td>
											<td style="padding: 10px;"><textarea name="faq_content"
													rows="5" cols="50" style="width: 100%; padding: 5px;"></textarea>
											</td>
										</tr>
										<tr>
											<td colspan="2" align="center" style="padding: 10px;"><input
												...
												href="faqView" style="font-size: 16px; padding: 10px 20px;">목록보기</a>
											</td>
										</tr>
									</form>
								</table>
						...
						<div class="inner1600 clearfix">
							<div class="right">
								...
								<a href="https://www.osulloc.com/kr/ko/login/logout"
									...
									target="_blank" class="btn-share--circle"
									style="z-index: 10000;" data-track-name="Footer 오설록 유튜브"> <img
									class="hide_tablet hide_mobile"
									src="https://image.osulloc.com/kr/ko/static_cdj/images/sns/sns_y.png"
									alt="유튜브">
								</a> <a href="https://www.instagram.com/osulloc_official/"
									target="_blank" class="btn-share--circle"
									style="z-index: 10000;" data-track-name="Footer 오설록 인스타그램">
						...
						<div class="inner1600 clearfix">
							...
							<div class="left">
								<div class="cont1">
									<ul>
										...
										<li><a
											href="https://www.osulloc.com/kr/ko/misc/procedures"
								...
								<div class="cont2">
									<div class="address">
										...
										대해서는 통신판매중개자 이며 통신판매의 당사자가 아닙니다. <br>따라서 입점판매자가 등록한 상품정보
										및 거래에 대해 책임을 지지 않습니다.
									</div>
							...
							<div class="right">
								<div class="box clearfix">
									...
									<div class="note">고객님의 안전거래를 위해 현금 등으로 결제 시 저희 쇼핑몰에 가입한
										NHN KCP의 구매안전서비스를 이용하실 수 있습니다.</div>
									<img
					...
					<div class="m_footer hide_pc">
						...
						<div class="certificationInfo">
							...
							<div class="txt_wrap">
								...
								<p>
									NHN KCP 구매안전(에스크로)서비스 <br> 고객님의 안전거래를 위해 현금 등으로 결제 시 저희
									쇼핑몰에 가입한 NHN KCP의 구매안전서비스를 이용하실 수 있습니다.
								</p>
							</div>
						</div>
						...
						<div class="footbottom">
							...
							<div class="snsWrap clearfix">
								...
								<a href="https://www.tiktok.com/@osulloc_official"
									target="_blank" class="ic ic-tiktok"
									data-track-name="Footer_M 오설록 틱톡">tiktok</a> <a
									href="https://www.youtube.com/channel/UC27q_WWuOkdyNIr7M_6trvA"
