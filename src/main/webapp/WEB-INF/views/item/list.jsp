...
@media screen and (max-width: 750px) {
	...
	.CatBannerM {
		display: block;
			...
			<div class="CatBanner"
				style="background-image: url(https://image.osulloc.com/kr/ko/static_cdj/images/catBanner/banner_teaprod.jpg)">
				<h2 class="CatBannerTit">티 제품</h2>
				<img
					src="https://image.osulloc.com/kr/ko/static_cdj/images/catBanner/banner_m_teaprod.jpg"
					alt="" class="CatBannerM">
			</div>
			<script>
				$(function(){
			...
			<div class="inner1600 itemListPocus">
				<div class="teashopWrapper ">
					...
					<div class="containter">
						...
						<div class="mSort-bar  js_select">


							<p class="tit menu">추천순</p>
							<ul class="opt">

								<li><a id="review"
									href="/kr/ko/shop/item/list?1=1&amp;sort=review"
									class="name on"> 추천순 </a></li>

								<li><a id="popular"
									href="/kr/ko/shop/item/list?1=1&amp;sort=popular" class="name">
								...
								<li><a id="new_arrival"
									href="/kr/ko/shop/item/list?1=1&amp;sort=new_arrival"
									class="name"> 신상품순 </a></li>

								<li><a id="price_desc"
									href="/kr/ko/shop/item/list?1=1&amp;sort=price_desc"
									class="name"> 높은 가격순 </a></li>

								<li><a id="price_asc"
									href="/kr/ko/shop/item/list?1=1&amp;sort=price_asc"
									class="name"> 낮은 가격순 </a></li>
						...
						<div class="sortingFilters">
							<!-- <p>총 <strong>277</strong>개의 상품이 있습니다.</p> -->
							<p></p>
							...
							<div class="filterGroup packageType">
								...
								<a href="#" class="filter">티백</a>
								<a href="#" class="filter">파우더</a> -->

								<a id="tealeaf" style="cursor: pointer;"
									class="filter  
							    	" data-track-name="잎차/라인별">잎차</a>

								<a id="pyramid" style="cursor: pointer;"
									class="filter  
							    	" data-track-name="피라미드/라인별">피라미드</a>

								<a id="teabag" style="cursor: pointer;"
									class="filter  
							    	" data-track-name="티백/라인별">티백</a>

								<a id="powder" style="cursor: pointer;"
									class="filter  
							    	" data-track-name="파우더/라인별">파우더</a>
