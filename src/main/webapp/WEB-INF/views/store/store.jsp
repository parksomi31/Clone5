			...
			<div class="stdd_store_wrap osl_stdd_common_wrap">
				...
				<section class="intro">
					<div class="title_wrapper">
						<p class="title ryu_gh_font">매장 소개</p>
						<p class="description">
							오프라인 매장에서 다채로운 <br class="mobile">오설록을 경험하세요.
						</p>
					</div>
					<div class="sticky_tab">
						<ul class="tab_list">
							<li class="tab_item active" data-tab="1"
								data-section="museum_slider"><a href="#museumSlider">티뮤지엄</a></li>
							<li class="tab_item" data-tab="2" data-section="shop_teahouse"><a
								href="#stddTeaHouse">티하우스</a></li>
							<li class="tab_item" data-tab="3" data-section="shop_find_place"><a
								href="#stddTeaShop">티샵</a></li>
						</ul>
					</div>

				</section>

				<section id="museumSlider"
					class="observe_tab museum_slider swiper-container-initialized swiper-container-horizontal"
					data-tab="1">
					<ul class="swiper-wrapper"
						...
						<li
							...
							style="width: 1160px; margin-right: 10px;">
							<div class="bg">
								<picture>
								<source
									srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1-2_bg_mo.webp"
									media="(max-width:1024px)" type="image/webp">
								<source
									srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1-2_bg_pc.webp"
									type="image/webp">
								<source
									srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1-2_bg_mo.jpg"
									media="(max-width:1024px)" type="image/jpg">
								<source
									srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1-2_bg_pc.jpg"
									type="image/jpg">
								<img
									src="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1-2_bg_pc.jpg"
									alt="제주 오설록 티뮤지엄" class="pc"> <img
									src="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1-2_bg_mo.jpg"
									alt="제주 오설록 티뮤지엄" class="mobile"> </picture>
							</div>
							<article class="contents">
								<p class="title ryu_gh_font">제주 오설록 티뮤지엄</p>
								<p class="description">
									오설록의 역사를 간직하고 <br>차문화를 만들어가는 티 헤리티지 공간
								</p>
								<div class="action">
									<a class="link_btn" href="/kr/ko/store-introduction/2">더
										알아보기</a> <a class="link_btn" href="/kr/ko/store-introduction/2">예약하기</a>
								</div>
							</article>
						</li>
						<li class="swiper-slide swiper-slide-duplicate swiper-slide-prev"
							...
							<div class="bg">
								<picture>
								<source
									srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1-3_bg_mo.webp"
									media="(max-width:1024px)" type="image/webp">
								<source
									srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1-3_bg_pc.webp"
									type="image/webp">
								<source
									srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1-3_bg_mo.jpg"
									media="(max-width:1024px)" type="image/jpg">
								<source
									srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1-3_bg_pc.jpg"
									type="image/jpg">
								<img
									src="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1-3_bg_pc.jpg"
									alt="제주 오설록 티뮤지엄" class="pc"> <img
									src="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1-3_bg_mo.jpg"
									alt="제주 오설록 티뮤지엄" class="mobile"> </picture>
							</div>
							<article class="contents">
								<p class="title ryu_gh_font">제주 오설록 티뮤지엄</p>
						...
						<li class="swiper-slide swiper-slide-active"
							...
							<div class="bg">
								<picture>
								<source
									srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1_bg_mo.webp"
									media="(max-width:1024px)" type="image/webp">
								<source
									srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1_bg_pc.webp"
									type="image/webp">
								<source
									srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1_bg_mo.jpg"
									media="(max-width:1024px)" type="image/jpg">
								<source
									srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1_bg_pc.jpg"
									type="image/jpg">
								<img
									src="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1_bg_pc.jpg"
									alt="제주 오설록 티뮤지엄" class="pc"> <img
									src="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_st/osl_stdd_st_1_bg_mo.jpg"
									alt="제주 오설록 티뮤지엄" class="mobile"> </picture>
							</div>
							<article class="contents">
								<p class="title ryu_gh_font">제주 오설록 티뮤지엄</p>
					...
					<div
						class="swiper-pagination white_pagination swiper-pagination-clickable swiper-pagination-bullets">
						<span
				...
				<section id="stddTeaHouse"
					class="section_wrap shop_teahouse observe_tab" data-tab="2">
					<div class="intro">
						<div class="info">
							<p class="title">오설록 티하우스</p>
							<p class="description">여유로운 찻자리와 특색있는 경험이 있는 차문화공간입니다.</p>
						</div>
						<div class="tool"></div>
					</div>

					<ul class="shop_teahouse_list">
						<c:forEach items="${stores}" var="dto">
							<li class="teahouse_item">
								<div class="thumb">
									<img src="${dto.image}" alt="${dto.title}">
								</div>
								<article class="info">
									<p class="place ryu_gh_font">${dto.title}</p>
