...
<link rel="stylesheet"
	href="https://image.osulloc.com/kr/ko/static_renew/css/style/main.css?ver=230503_1">
...
<body class="is_pc is_hover">
	...
	<script
		src="https://image.osulloc.com/kr/ko/static_cdj/js/main.js?ver=20231108_2"></script>
	<!--[if lt IE 9]><link rel="stylesheet" href="https://image.osulloc.com/kr/ko/static/css/old-ie.css"><![endif]-->
	<!-- 20180612 braze s-->
	<link rel="manifest" href="/manifest.json">
	<!-- 20180612 braze e -->
	...
	<link rel="stylesheet"
		href="https://image.osulloc.com/kr/ko/static_cdj/others/css/stdd_common.css?ver=230515_1">
	<link rel="stylesheet"
		href="https://image.osulloc.com/kr/ko/static_cdj/others/css/stdd_main.css?ver=230829_1">
	<script
...
function ga360_textLengthOverCut(c,a,b){try{if(""==a||null==a)a=20;if(""==b||null==b)b="...";c.length>a&&(c=c.substr(0,a)+b)}catch(d){}return c};</script>
	<script
		src="https://image.osulloc.com/kr/ko/static_cdj/others/js/stdd_main.js"
		type="text/javascript"></script>
	...
	<div class="cdj_renew">
		<div class="main_top_banner">
			<div
				class="swiper-container banner_list swiper-container-initialized swiper-container-vertical">
				<div class="swiper-wrapper"
					style="transition-duration: 0ms; transform: translate3d(0px, -108px, 0px);">
					<div
						class="swiper-slide item swiper-slide-duplicate swiper-slide-next swiper-slide-duplicate-prev"
						style="background-color: rgb(70, 69, 69); color: rgb(255, 255, 255); height: 36px;"
						data-swiper-slide-index="1">
						<a href="" class="link">3만 5천원 이상 구매 시 시트 마스크 2매 증정!</a>
					</div>
					<!-- background-color는 관리자에서 지정 -->

					<div class="swiper-slide item swiper-slide-duplicate-active"
						style="background-color: rgb(70, 69, 69); color: rgb(255, 255, 255); height: 36px;"
						data-swiper-slide-index="0">
						<a href="" class="link">3만원 이상 구매 시 무료배송</a>
					</div>

					<div
						class="swiper-slide item swiper-slide-prev swiper-slide-duplicate-next"
						style="background-color: rgb(70, 69, 69); color: rgb(255, 255, 255); height: 36px;"
						data-swiper-slide-index="1">
						<a href="" class="link">3만 5천원 이상 구매 시 시트 마스크 2매 증정!</a>
					</div>
					...
					<div
						class="swiper-slide item swiper-slide-duplicate swiper-slide-active"
						style="background-color: rgb(70, 69, 69); color: rgb(255, 255, 255); height: 36px;"
						data-swiper-slide-index="0">
						<a href="" class="link">3만원 이상 구매 시 무료배송</a>
					</div>
			...
			<button class="main_top_banner_close">
				<img
					src="https://image.osulloc.com/kr/ko/static_cdj/images/main/icon_main_top_banner_close.png"
					alt="배너 닫기" style="user-select: none;">
			</button>
		</div>
	</div>
	<!-- 상단 띠배너 : E -->
	...
	<!-------------------------------------------------------
 header include 영역 입니다. 메인은 여기에 헤더를 넣어주세요.
 -------------------------------------------------------->
	...
	<div class="cdj_renew">
		...
		<div class="pcHeaderBannerArea">
			<div class="searchArea hasBanner">
				<div class="searchInnerArea">
					...
					<div class="chartBox">
						<div class="chartList">
							<div class="tit">
								<p>인기 검색어</p>
								<em class="searchDateDiv"> 24. 06. 28 기준 </em>
							</div>
							<ul class="popular_list">
								<li class="rank"><p>
										<b>1</b><strong onclick="setHeaderSearchKeyword(this)"
											data-tag-search-type="favorite" data-text="콤부차"
											style="cursor: pointer;">콤부차</strong>
									</p> <i class="rankState flagstatus"></i></li>
								<li class="rank"><p>
										<b>2</b><strong onclick="setHeaderSearchKeyword(this)"
											data-tag-search-type="favorite" data-text="아이스티"
											style="cursor: pointer;">아이스티</strong>
									</p> <i class="rankState flagstatus"></i></li>
								<li class="rank"><p>
										<b>3</b><strong onclick="setHeaderSearchKeyword(this)"
											data-tag-search-type="favorite" data-text="웨딩"
											style="cursor: pointer;">웨딩</strong>
									</p> <i class="rankState flagstatus"></i></li>
								<li class="rank"><p>
										<b>4</b><strong onclick="setHeaderSearchKeyword(this)"
											data-tag-search-type="favorite" data-text="티세트"
											style="cursor: pointer;">티세트</strong>
									</p> <i class="rankState flagstatus"></i></li>
								<li class="rank"><p>
										<b>5</b><strong onclick="setHeaderSearchKeyword(this)"
											data-tag-search-type="favorite" data-text="캐모마일"
											style="cursor: pointer;">캐모마일</strong>
									</p> <i class="rankState flegUp"></i></li>
								<li class="rank"><p>
										<b>6</b><strong onclick="setHeaderSearchKeyword(this)"
											data-tag-search-type="favorite" data-text="구름노래"
											style="cursor: pointer;">구름노래</strong>
									</p> <i class="rankState flagstatus"></i></li>
								<li class="rank"><p>
										<b>7</b><strong onclick="setHeaderSearchKeyword(this)"
											data-tag-search-type="favorite" data-text="히비스커스 선 샤인"
											style="cursor: pointer;">히비스커스 선 샤인</strong>
									</p> <i class="rankState flagDown"></i></li>
								<li class="rank"><p>
										<b>8</b><strong onclick="setHeaderSearchKeyword(this)"
											data-tag-search-type="favorite" data-text="난꽃"
											style="cursor: pointer;">난꽃</strong>
									</p> <i class="rankState flagDown"></i></li>
								<li class="rank"><p>
										<b>9</b><strong onclick="setHeaderSearchKeyword(this)"
											data-tag-search-type="favorite" data-text="꿀배"
											style="cursor: pointer;">꿀배</strong>
									</p> <i class="rankState flagDown"></i></li>
								<li class="rank"><p>
						...
						<div class="chartBox">
							...
							<div class="chartList not_auto_complete">
								<div id="tab01" class="tabCnt" style="display: block;">
									...
									<p class="log date searchDateDiv">24. 06. 28 기준</p>
								</div>
    ...
    function bannerShow() {
 	...
 	window.onload = function() {
	  // 로그인 안되었을때
	  if('false' == 'false'){
		var chkCid = "236257190.1719211052";
	...
	<main
		class="main cdj_renew main_contents stdd_main_wrap osl_stdd_common_wrap">
		<!-- 메인배너 : S -->
		<section class="main_sec">
			<div class="main_banner">
				<div
					class="main_banner_slide swiper-container swiper-container-fade swiper-container-initialized swiper-container-horizontal">
					<div class="swiper-wrapper" style="transition-duration: 0ms;">
						<div
							class="swiper-slide swiper-slide-duplicate swiper-slide-next swiper-slide-duplicate-prev"
							data-swiper-slide-index="2"
							style="width: 933px; transition-duration: 0ms; opacity: 1; transform: translate3d(0px, 0px, 0px);">


							<a href="https://www.osulloc.com/kr/ko/shop/item/teashop/21672"
								ap-click-area="MAIN" ap-click-name="MAIN_메인배너"
								ap-click-data="2,공식 홈페이지 단독 구성<br>해차 세작 에디션 세트">
								...
								<div class="img_box">
									...
									<img class="pcBlock"
										srcset="https://image.osulloc.com/upload/kr/ko/adminImage/ZF/TV/20240521095825847IN.webp"
										src="https://image.osulloc.com/upload/kr/ko/adminImage/ZF/TV/20240521095825847IN.jpg"
										width="1920" height="630" alt="mainBanner"
										style="user-select: none;"> <img class="moBlock"
										srcset="https://image.osulloc.com/upload/kr/ko/adminImage/NK/RR/20240521095828704VC.webp"
										src="https://image.osulloc.com/upload/kr/ko/adminImage/NK/RR/20240521095828704VC.jpg"
										alt="mainBannerMobile">
								</div>
								<div class="align_box">
									<div class="text_box">
										<h3 class="ban_title">
											공식 홈페이지 단독 구성<br>해차 세작 에디션 세트
										</h3>
										<p class="onepoint">
									...
									<button type="button" title="이벤트 전체보기"
										class="btn_event_go pcBlock"
										onclick="location.href='https://www.osulloc.com/kr/ko/life/event/list/ing';return false;">이벤트
										전체보기</button>
									<input type="text" hidden=""
										value="https://image.osulloc.com/upload/kr/ko/adminImage/NK/RR/20240521095828704VC.jpg"
										class="iptMo"> <input type="text" hidden=""
										value="https://image.osulloc.com/upload/kr/ko/adminImage/ZF/TV/20240521095825847IN.jpg"
										class="iptPc"> <input type="text" hidden=""
										value="https://image.osulloc.com/upload/kr/ko/adminImage/NK/RR/20240521095828704VC.webp"
										class="iptMoWebp"> <input type="text" hidden=""
										value="https://image.osulloc.com/upload/kr/ko/adminImage/ZF/TV/20240521095825847IN.webp"
										class="iptPcWebp">
								</div>
							</a>
						</div>
						...
						<div class="swiper-slide swiper-slide-duplicate-active"
							...
							<a href="/kr/ko/life/event/view/12078" ap-click-area="MAIN"
								ap-click-name="MAIN_메인배너"
								ap-click-data="0,차갑게 먹으면 더 맛있는<br> 진한 말차맛 티푸드"
								ap-data-promotion="{&quot;promotion_id&quot; : &quot;12078&quot;, &quot;promotion_name&quot; : &quot;차갑게 먹으면 더 맛있는<br> 진한 말차맛 티푸드&quot;, &quot;creative_slot&quot; : &quot;메인 베너&quot;}">
								...
								<div class="img_box">
									...
									<img class="pcBlock"
										srcset="https://image.osulloc.com/upload/kr/ko/adminImage/EV/JJ/20240612132101114ZX.webp"
										src="https://image.osulloc.com/upload/kr/ko/adminImage/EV/JJ/20240612132101114ZX.jpg"
										width="1920" height="630" alt="mainBanner"
										style="user-select: none;"> <img class="moBlock"
										srcset="https://image.osulloc.com/upload/kr/ko/adminImage/NY/ZN/20240612132104935OB.webp"
										src="https://image.osulloc.com/upload/kr/ko/adminImage/NY/ZN/20240612132104935OB.jpg"
										alt="mainBannerMobile">
								</div>
								<div class="align_box">
									<div class="text_box">
										<h3 class="ban_title">
											차갑게 먹으면 더 맛있는<br> 진한 말차맛 티푸드
										</h3>
										<p class="onepoint">



											말차의 깊은 풍미에 달콤함을 더한<br> 오설록 티푸드를 지금 만나보세요.


										</p>
										<p class="date">06.17 - 07.01</p>
									</div>
									<button type="button" title="이벤트 전체보기"
										class="btn_event_go pcBlock"
										onclick="location.href='https://www.osulloc.com/kr/ko/life/event/list/ing';return false;">이벤트
										전체보기</button>
									<input type="text" hidden=""
										value="https://image.osulloc.com/upload/kr/ko/adminImage/NY/ZN/20240612132104935OB.jpg"
										class="iptMo"> <input type="text" hidden=""
										value="https://image.osulloc.com/upload/kr/ko/adminImage/EV/JJ/20240612132101114ZX.jpg"
										class="iptPc"> <input type="text" hidden=""
										value="https://image.osulloc.com/upload/kr/ko/adminImage/NY/ZN/20240612132104935OB.webp"
										class="iptMoWebp"> <input type="text" hidden=""
										value="https://image.osulloc.com/upload/kr/ko/adminImage/EV/JJ/20240612132101114ZX.webp"
										class="iptPcWebp">
								</div>
							</a>
						</div>
						...
						<div class="swiper-slide" data-swiper-slide-index="1"
							style="width: 933px; transition-duration: 0ms; opacity: 1; transform: translate3d(-1866px, 0px, 0px);">


							<a href="/kr/ko/life/event/view/12076" ap-click-area="MAIN"
								ap-click-name="MAIN_메인배너"
								ap-click-data="1,부드러운 시트러스 향미<br> 귤꽃향을 품은 우잣담"
								ap-data-promotion="{&quot;promotion_id&quot; : &quot;12076&quot;, &quot;promotion_name&quot; : &quot;부드러운 시트러스 향미<br> 귤꽃향을 품은 우잣담&quot;, &quot;creative_slot&quot; : &quot;메인 베너&quot;}">
								...
								<div class="img_box">
									...
									<img class="pcBlock"
										srcset="https://image.osulloc.com/upload/kr/ko/adminImage/OQ/RB/20240530140726796JD.webp"
										src="https://image.osulloc.com/upload/kr/ko/adminImage/OQ/RB/20240530140726796JD.jpg"
										width="1920" height="630" alt="mainBanner"
										style="user-select: none;"> <img class="moBlock"
										srcset="https://image.osulloc.com/upload/kr/ko/adminImage/NJ/KI/20240530140729776IB.webp"
										src="https://image.osulloc.com/upload/kr/ko/adminImage/NJ/KI/20240530140729776IB.jpg"
										alt="mainBannerMobile">
								</div>
								<div class="align_box">
									<div class="text_box">
										<h3 class="ban_title">
											부드러운 시트러스 향미<br> 귤꽃향을 품은 우잣담
										</h3>
										<p class="onepoint">



											귤꽃 향미가 가득한 블렌디드 티를<br> 최대 25% 할인 혜택으로 만나보세요.


										</p>
										<p class="date">06.01 - 06.30</p>
									</div>
									<button type="button" title="이벤트 전체보기"
										class="btn_event_go pcBlock"
										onclick="location.href='https://www.osulloc.com/kr/ko/life/event/list/ing';return false;">이벤트
										전체보기</button>
									<input type="text" hidden=""
										value="https://image.osulloc.com/upload/kr/ko/adminImage/NJ/KI/20240530140729776IB.jpg"
										class="iptMo"> <input type="text" hidden=""
										value="https://image.osulloc.com/upload/kr/ko/adminImage/OQ/RB/20240530140726796JD.jpg"
										class="iptPc"> <input type="text" hidden=""
										value="https://image.osulloc.com/upload/kr/ko/adminImage/NJ/KI/20240530140729776IB.webp"
										class="iptMoWebp"> <input type="text" hidden=""
										value="https://image.osulloc.com/upload/kr/ko/adminImage/OQ/RB/20240530140726796JD.webp"
										class="iptPcWebp">
								</div>
							</a>
						</div>
						...
						<div
							...
							data-swiper-slide-index="2"
							style="width: 933px; transition-duration: 0ms; opacity: 1; transform: translate3d(-2799px, 0px, 0px);">
						...
						<div
							...
							data-swiper-slide-index="0"
							style="width: 933px; transition-duration: 0ms; opacity: 1; transform: translate3d(-3732px, 0px, 0px);">
					...
					let moWebpArr = [];
					let pcWebpArr = [];
					document.querySelectorAll(".iptMo").forEach(e => moArr.push(e.value));
					document.querySelectorAll(".iptPc").forEach(e => pcArr.push(e.value));
					document.querySelectorAll(".iptMoWebp").forEach(e => moWebpArr.push(e.value));
					document.querySelectorAll(".iptPcWebp").forEach(e => pcWebpArr.push(e.value));

					const appendBanner = (e, i, type, imgBox) => {
						const oldNode = e.innerHTML;
						const index = i === 0 ? imgBox.length - 3 : i === imgBox.length - 1 ? 0 : i - 1;

						e.innerHTML = `
								${oldNode}
								<img 
									class="${type}Block" 
									srcset="${type == "mo" ? moWebpArr[index] : pcWebpArr[index]}" 
									src="${type == "mo" ? moArr[index] : pcArr[index]}" 
									alt="${type == "mo" ? 'mainBannerMobile' : 'mainBanner'}"
								>
							`;
					}

					window.addEventListener("resize", function(){
						const imgBox = document.querySelectorAll(".main_banner .swiper-slide .img_box");
						const moImg = document.querySelectorAll(".main_banner .swiper-slide img.moBlock").length;
						const pcImg = document.querySelectorAll(".main_banner .swiper-slide img.pcBlock").length;
						if(window.innerWidth < 1025 && !moImg){ //mo
							imgBox.forEach((e, i) => appendBanner(e, i, "mo", imgBox));
						} else if(window.innerWidth >= 1025 && !pcImg) { //pc
							imgBox.forEach((e, i) => appendBanner(e, i, "pc", imgBox));
						}
					});
				</script>
					<div class="align_box02">
						<button type="button" class="swiper-button-next main_slide_next"
							title="이전 슬라이드" tabindex="0" role="button"
							aria-label="Next slide"></button>
						<button type="button" class="swiper-button-prev main_slide_prev"
							title="" tabindex="0" role="button" aria-label="Previous slide"></button>
					</div>
					<div class="swiper_control">
						<div
							class="swiper_pagination swiper-pagination-clickable swiper-pagination-bullets">
							<span
						...
						<div class="swiper_play on">
							<button type="button" class="swiper_btn_play">
								<img
									srcset="https://image.osulloc.com/kr/ko/static_cdj/images/main/icon_btn_play.webp"
									src="https://image.osulloc.com/kr/ko/static_cdj/images/main/icon_btn_play.png"
									alt="재생" style="user-select: none;">
							</button>
							<button type="button" class="swiper_btn_pause">
								<img
									srcset="https://image.osulloc.com/kr/ko/static_cdj/images/main/icon_btn_pause.webp"
									src="https://image.osulloc.com/kr/ko/static_cdj/images/main/icon_btn_pause.png"
									alt="일시정지" style="user-select: none;">
							</button>
						</div>
						<div class="swiper_fraction">
							<div class="count">
								<span class="current">1</span> <span class="slash">/</span> <span
									class="total">3</span>
							</div>
							<button type="button" class="more">
								<img
									srcset="https://image.osulloc.com/kr/ko/static_cdj/images/main/icon_banner_more.webp"
									src="https://image.osulloc.com/kr/ko/static_cdj/images/main/icon_banner_more.png"
									alt="전체보기" style="user-select: none;">
							</button>
						</div>
					</div>
					<span class="swiper-notification" aria-live="assertive"
		...
		<!-- 메인배너 전체보기 레이어 팝업 (모바일) : S -->
		<section class="main_banner_layer" id="main_banner_layer"
			style="display: none;">
			<div class="banner_layer_wrap">
				<div class="banner_layer_box">
					<div class="layer_header">
						<h2 class="tit">전체보기</h2>
						<button class="main_banner_layer_close" type="button" title="닫기">
							<img
								srcset="https://image.osulloc.com/kr/ko/static_cdj/images/main/icon_mo_nav_close.webp"
								src="https://image.osulloc.com/kr/ko/static_cdj/images/main/icon_mo_nav_close.png"
								alt="전체보기 닫기" style="user-select: none;">
						</button>
					</div>
					<div class="layer_con">
						...
						<div class="layer_item">
							...
							<a href="/kr/ko/life/event/view/12078">

								<div class="img_box">
									<img class="moBlock"
										srcset="https://image.osulloc.com/upload/kr/ko/adminImage/NY/ZN/20240612132104935OB.webp"
										src="https://image.osulloc.com/upload/kr/ko/adminImage/NY/ZN/20240612132104935OB.jpg"
										alt="차갑게 먹으면 더 맛있는<br> 진한 말차맛 티푸드" style="user-select: none;">
						...
						<div class="layer_item">
							...
							<a href="/kr/ko/life/event/view/12076">

								<div class="img_box">
									<img class="moBlock"
										srcset="https://image.osulloc.com/upload/kr/ko/adminImage/NJ/KI/20240530140729776IB.webp"
										src="https://image.osulloc.com/upload/kr/ko/adminImage/NJ/KI/20240530140729776IB.jpg"
										alt="부드러운 시트러스 향미<br> 귤꽃향을 품은 우잣담" style="user-select: none;">
						...
						<div class="layer_item">
							...
							<a href="https://www.osulloc.com/kr/ko/shop/item/teashop/21672"
								ap-data-promotion="{&quot;promotion_id&quot; : &quot;12071&quot;, &quot;promotion_name&quot; : &quot;공식 홈페이지 단독 구성<br>해차 세작 에디션 세트&quot;, &quot;creative_slot&quot; : &quot;메인 베너&quot;}">
								...
								<div class="img_box">
									<img class="moBlock"
										srcset="https://image.osulloc.com/upload/kr/ko/adminImage/NK/RR/20240521095828704VC.webp"
										src="https://image.osulloc.com/upload/kr/ko/adminImage/NK/RR/20240521095828704VC.jpg"
										alt="공식 홈페이지 단독 구성<br>해차 세작 에디션 세트" style="user-select: none;">
								...
								<div class="text_box">
									...
									<p class="onepoint">
										...
										해차 수확을 맞이해 시즌 한정으로 준비한<br> 특별한 구성. 20%~ 할인 및 쇼핑백 증정 등 다양한
										혜택까지!
						...
						<div class="layer_item">
							<a href="/kr/ko/life/event/view/10682">
								<div class="img_box">
									<img
										srcset="https://image.osulloc.com/upload/kr/ko/event/220510/evt_banner2.webp"
										src="https://image.osulloc.com/upload/kr/ko/event/220510/evt_banner2.jpg"
										alt="" class="moBlock" style="user-select: none;">
								</div>
								<div class="text_box">
									<h3 class="ban_title">대량 구매 상담 안내</h3>
									<p class="onepoint">대량 구매 시 특별한 혜택을 드립니다.</p>
									<p class="date">01.01 - 12.31</p>
								</div>
							</a>
						</div>
					</div>
		...
		<section class="main_sec">
			<div class="quick_banner">
				<div class="w1200">
					<div
						class="quick_banner_slide swiper-container swiper-container-initialized swiper-container-horizontal">
						<div class="swiper-wrapper"
							style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
							<div class="swiper-slide swiper-slide-active"
								style="width: 201.19px; margin-right: 15px;">
								<a href="/kr/ko/shop/item/list?category=teashop">
									<div class="img_box">
										<img
											srcset="https://image.osulloc.com/kr/ko/static_cdj/images/main/quick_img01.webp"
											src="https://image.osulloc.com/kr/ko/static_cdj/images/main/quick_img01.png"
											width="100" height="100" alt="티" style="user-select: none;">
									</div>
									<p class="text_box">티 제품</p>
								</a>
							</div>
							<div class="swiper-slide swiper-slide-next"
								style="width: 201.19px; margin-right: 15px;">
								<a href="/kr/ko/shop/item/list?category=bakery">
									<div class="img_box">
										<img
											srcset="https://image.osulloc.com/kr/ko/static_cdj/images/main/quick_img02.webp"
											src="https://image.osulloc.com/kr/ko/static_cdj/images/main/quick_img02.png"
											width="100" height="100" alt="티푸드" style="user-select: none;">
									</div>
									<p class="text_box">티푸드</p>
								</a>
							</div>
							<div class="swiper-slide"
								...
								<a href="/kr/ko/shop/item/gift">
									<div class="img_box">
										<img
											srcset="https://image.osulloc.com/kr/ko/static_cdj/images/main/quick_giftshop.webp"
											src="https://image.osulloc.com/kr/ko/static_cdj/images/main/quick_giftshop.jpg"
											width="100" height="100" alt="선물추천"
											style="user-select: none;">
									</div>
									<p class="text_box">선물추천</p>
								</a>
							</div>
			...
			<div class="w1200">
				<div class="main_notice">
					...
					<ul class="notice_list" id="notice_list">
						...
						<li class="item"><a
							href="https://www.osulloc.com/kr/ko/cs/notice/news/6316"
							data-track-name="Footer_M 공지사항">[공지] 하절기 초콜릿류 제품 배송 중단 (6/3~)</a></li>
						<li class="item"><a
							href="https://www.osulloc.com/kr/ko/cs/notice/news/6307"
							data-track-name="Footer_M 공지사항">[공지] 오설록몰 개인정보처리방침 변경 안내 (24.
								02. 29)</a></li>
						<li class="item"><a
							href="https://www.osulloc.com/kr/ko/cs/notice/news/6319"
							data-track-name="Footer_M 공지사항">[공지] 오설록몰 개인정보처리방침 변경 안내 (24.
								06. 27)</a></li>
						<li class="item"><a
							href="https://www.osulloc.com/kr/ko/cs/notice/news/6318"
							data-track-name="Footer_M 공지사항">[공지] 오설록 제주 얼그레이 용량 변경의 건</a></li>
						<li class="item"><a
							href="https://www.osulloc.com/kr/ko/cs/notice/news/6317"
							data-track-name="Footer_M 공지사항">[공지] 오설록몰 개인정보처리방침 변경 안내 (24.
								06. 03)</a></li>
					</ul>
					<button type="button" class="notice_more_btn" title="공지사항 더보기"
						onclick="javascript:location.href='https://www.osulloc.com/kr/ko/cs/notice'"></button>
				</div>
		...
		<section class="main_sec line01">
			<div class="main_prd_list">
				<div class="w1200">
					<div class="tit_box">
						...
						<ul class="prd_tab">
							...
							<li class="tab_item on">이번 주 인기 제품</li>
						</ul>
					</div>
				</div>
				...
				<div class="w1200_2">
					<!-- tab_con01 : S -->
					<div class="prd_tab_con prd_tab_con01">
						<div class="prd_list_box">
							<div
								class="prd_list_slide prd_list_slide01 swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-multirow mo">
								<div class="swiper-wrapper" style="width: 2679px;">



									<div class="swiper-slide swiper-slide-active"
										data-swiper-column="0" data-swiper-row="0"
										style="order: 0; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/teashop/15263"> <img
												...
												width="224" height="251" alt="" style="user-select: none;">
											...
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_gift_btn"
													onclick="goPresent('15263','28000')" title="선물"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/teashop/15263">프리미엄 티 컬렉션 10종
														40입</a>
												</p>
												<div class="prd_price">
									...
									<div class="swiper-slide swiper-slide-next"
										data-swiper-column="0" data-swiper-row="1"
										style="-webkit-box-ordinal-group: 3; order: 3; margin-top: 0px; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/teashop/1461"> <img
												class="prd_thumb_default"
											...
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_gift_btn"
													onclick="goPresent('1461','21000')" title="선물"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/teashop/1461">러블리 티 박스 4종 12입</a>
												</p>
												<div class="prd_price">
									...
									<div class="swiper-slide" data-swiper-column="0"
										data-swiper-row="2"
										style="-webkit-box-ordinal-group: 6; order: 6; margin-top: 0px; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/teashop/5764"> <img
												class="prd_thumb_default"
											...
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_gift_btn"
													onclick="goPresent('5764','47000')" title="선물"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/teashop/5764">시크릿 티 스토리 9종
														27입</a>
												</p>
												<div class="prd_price">
									...
									<div class="swiper-slide" data-swiper-column="1"
										data-swiper-row="0"
										style="-webkit-box-ordinal-group: 1; order: 1; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/teashop/14123"> <img
												class="prd_thumb_default"
											...
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_gift_btn"
													onclick="goPresent('14123','55000')" title="선물"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/teashop/14123">마스터 블렌드 8종 32입</a>
												</p>
												<div class="prd_price">
									...
									<div class="swiper-slide" data-swiper-column="1"
										data-swiper-row="1"
										style="-webkit-box-ordinal-group: 4; order: 4; margin-top: 0px; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/teashop/16045"> <img
												class="prd_thumb_default"
											...
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_gift_btn"
													onclick="goPresent('16045','70000')" title="선물"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/teashop/16045">프리미엄 티 컬렉션 9종
														90입</a>
												</p>
												<div class="prd_price">
									...
									<div class="swiper-slide" data-swiper-column="1"
										data-swiper-row="2"
										style="-webkit-box-ordinal-group: 7; order: 7; margin-top: 0px; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/teashop/20826"> <img
												class="prd_thumb_default"
											...
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_gift_btn"
													onclick="goPresent('20826','95000')" title="선물"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/teashop/20826">스페셜 티 에디션 9종
														54입</a>
												</p>
												<div class="prd_price">
													...
													<div class="flex_box">
														<p class="price_result">95,000원</p>
													</div>
									...
									<div class="swiper-slide" data-swiper-column="2"
										data-swiper-row="0"
										style="-webkit-box-ordinal-group: 2; order: 2; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/teashop/15824"> <img
												class="prd_thumb_default"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/KF/NE/304_20220401151823970TE.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/KF/NE/304_20220401151823970TE.png"
												width="224" height="251" alt="" style="user-select: none;">
												<img class="prd_thumb_hover"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/JI/YV/20220401151829295RG.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/JI/YV/20220401151829295RG.png"
												width="224" height="251" alt="" style="user-select: none;">
											</a>
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_gift_btn"
													onclick="goPresent('15824','29500')" title="선물"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/teashop/15824">프루티 블렌디드 티백 박스
														3종 60입</a>
												</p>
												<div class="prd_price">
													...
													<div class="flex_box">
														<p class="price_result">29,500원</p>
													</div>
									...
									<div class="swiper-slide" data-swiper-column="2"
										data-swiper-row="1"
										style="-webkit-box-ordinal-group: 5; order: 5; margin-top: 0px; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/teashop/15823"> <img
												class="prd_thumb_default"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/CH/DH/304_20230410111719631GP.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/CH/DH/304_20230410111719631GP.png"
												width="224" height="251" alt="" style="user-select: none;">
												<img class="prd_thumb_hover"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/JS/RF/20230410111726295AI.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/JS/RF/20230410111726295AI.png"
												width="224" height="251" alt="" style="user-select: none;">
											</a>
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_gift_btn"
													onclick="goPresent('15823','29500')" title="선물"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/teashop/15823">베스트 블렌디드 티백 박스
														3종 60입</a>
												</p>
												<div class="prd_price">
								...
								<div
									class="swiper-pagination prd_list_pagination swiper-pagination-clickable swiper-pagination-bullets">
									<span
										class="swiper-pagination-bullet swiper-pagination-bullet-active"
										tabindex="0" role="button" aria-label="Go to slide 1"></span><span
										class="swiper-pagination-bullet" tabindex="0" role="button"
							...
							<div class="swiper-button-next main_slide_next" tabindex="0"
								role="button" aria-label="Next slide" aria-disabled="false"></div>
							<div
								class="swiper-button-prev main_slide_prev swiper-button-disabled"
								tabindex="0" role="button" aria-label="Previous slide"
								aria-disabled="true"></div>
						</div>
						<div class="main_btn_typeA">
							<button type="button" class="btn_A"
								onclick="javascript:location.href='/kr/ko/shop/item/list/best/recommand'">
								<span>더 보기</span>
							</button>
						</div>
					</div>
					...
					<!-- tab_con02 : S -->
					<div class="prd_tab_con prd_tab_con02 on">
						<div class="prd_list_box">
							<div
								class="prd_list_slide prd_list_slide02 swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-multirow mo">
								<div class="swiper-wrapper" style="width: 3572px;">
									...
									<div class="swiper-slide swiper-slide-active"
										...
										style="order: 0; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/teashop/21672"> <img
												class="prd_thumb_default"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/MZ/PE/304_20240531181226694SL.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/MZ/PE/304_20240531181226694SL.png"
												width="224" height="251" alt="" style="user-select: none;">
												<img class="prd_thumb_hover"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/FX/OC/20240531181230566LQ.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/FX/OC/20240531181230566LQ.png"
												width="224" height="251" alt="" style="user-select: none;">
											</a>
											<!-- 아이콘 클릭하면 prd_btn에 on 클래스 붙음 -->
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_cart_btn"
													title="장바구니" data-add-url="/kr/ko/shop/cart/add/21672"
													data-item-name="[단독 구성] 골든픽 해차 세작 에디션 세트"
													data-item-state="onsale" data-item-price="32000"
													data-is-purchase="true"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/teashop/21672">[단독 구성] 골든픽 해차
														세작 에디션 세트</a>
												</p>
												<div class="prd_price">
													...
													<p class="price_origin">32,000원</p>
													<div class="flex_box">
														<p class="price_result">20,800원</p>
														<p class="sale_percent">35%</p>
													</div>
									...
									<div class="swiper-slide swiper-slide-next"
										...
										style="-webkit-box-ordinal-group: 4; order: 4; margin-top: 0px; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/bakery/14943"> <img
												class="prd_thumb_default"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/YV/PB/304_20240528181553834KW.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/YV/PB/304_20240528181553834KW.png"
												width="224" height="251" alt="" style="user-select: none;">
												<img class="prd_thumb_hover"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/RI/FN/20240528181557043CG.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/RI/FN/20240528181557043CG.png"
												width="224" height="251" alt="" style="user-select: none;">
											</a>
											<!-- 아이콘 클릭하면 prd_btn에 on 클래스 붙음 -->
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_cart_btn"
													title="장바구니" data-add-url="/kr/ko/shop/cart/add/14943"
													data-item-name="그린티 랑드샤" data-item-state="onsale"
													data-item-price="13000" data-is-purchase="true"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												...
												<div class="prd_price">
													...
													<p class="price_origin">13,000원</p>
													<div class="flex_box">
														<p class="price_result">11,700원</p>
														<p class="sale_percent">10%</p>
													</div>
									...
									<div class="swiper-slide" data-swiper-column="0"
										data-swiper-row="2"
										style="-webkit-box-ordinal-group: 8; order: 8; margin-top: 0px; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/teashop/6362"> <img
												class="prd_thumb_default"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/WU/OB/304_20221229163433071ZU.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/WU/OB/304_20221229163433071ZU.png"
												width="224" height="251" alt="" style="user-select: none;">
												<img class="prd_thumb_hover"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/SI/TN/20240418171437025LD.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/SI/TN/20240418171437025LD.png"
												width="224" height="251" alt="" style="user-select: none;">
											</a>
											<!-- 아이콘 클릭하면 prd_btn에 on 클래스 붙음 -->
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_cart_btn"
													title="장바구니" data-add-url="/kr/ko/shop/cart/add/6362"
													data-item-name="찬물 녹차" data-item-state="onsale"
													data-item-price="9500" data-is-purchase="true"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/teashop/6362">찬물 녹차</a>
												</p>
												<div class="prd_price">
													...
													<p class="price_origin">9,500원</p>
													<div class="flex_box">
														<p class="price_result">6,650원</p>
														<p class="sale_percent">30%</p>
													</div>
									...
									<div class="swiper-slide" data-swiper-column="1"
										...
										style="-webkit-box-ordinal-group: 1; order: 1; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/teashop/17585"> <img
												class="prd_thumb_default"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/UQ/WN/304_20240531181428215QY.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/UQ/WN/304_20240531181428215QY.png"
												width="224" height="251" alt="" style="user-select: none;">
												<img class="prd_thumb_hover"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/FK/WA/20240531181432909MR.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/FK/WA/20240531181432909MR.png"
												width="224" height="251" alt="" style="user-select: none;">
											</a>
											<!-- 아이콘 클릭하면 prd_btn에 on 클래스 붙음 -->
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_cart_btn"
													title="장바구니" data-add-url="/kr/ko/shop/cart/add/17585"
													data-item-name="[2024년 골든픽] 세작 20입"
													data-item-state="onsale" data-item-price="28000"
													data-is-purchase="true"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/teashop/17585">[2024년 골든픽] 세작
														20입</a>
												</p>
												<div class="prd_price">
									...
									<div class="swiper-slide" data-swiper-column="1"
										...
										<div class="prd_thumb">
											...
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_cart_btn"
													title="장바구니" data-add-url="/kr/ko/shop/cart/add/15263"
													data-item-name="프리미엄 티 컬렉션 10종 40입"
													data-item-state="onsale" data-item-price="28000"
													data-is-purchase="true"></button>
											</div>
										</div>
									...
									<div class="swiper-slide" data-swiper-column="1"
										data-swiper-row="2"
										style="-webkit-box-ordinal-group: 9; order: 9; margin-top: 0px; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/teashop/21660"> <img
												class="prd_thumb_default"
											...
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_cart_btn"
													title="장바구니" data-add-url="/kr/ko/shop/cart/add/21660"
													data-item-name="티 베리에이션 30 6종 30입" data-item-state="onsale"
													data-item-price="22000" data-is-purchase="true"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/teashop/21660">티 베리에이션 30 6종
														30입</a>
												</p>
												<div class="prd_price">
									...
									<div class="swiper-slide" data-swiper-column="2"
										...
										style="-webkit-box-ordinal-group: 2; order: 2; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/teashop/16643"> <img
												class="prd_thumb_default"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/EH/PI/304_20220818110344724FX.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/EH/PI/304_20220818110344724FX.png"
												width="224" height="251" alt="" style="user-select: none;">
												<img class="prd_thumb_hover"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/AF/KU/20220818110349591YK.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/AF/KU/20220818110349591YK.png"
												width="224" height="251" alt="" style="user-select: none;">
											</a>
											<!-- 아이콘 클릭하면 prd_btn에 on 클래스 붙음 -->
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_cart_btn"
													title="장바구니" data-add-url="/kr/ko/shop/cart/add/16643"
													data-item-name="세작 40g" data-item-state="onsale"
													data-item-price="17000" data-is-purchase="true"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/teashop/16643">세작 40g</a>
												</p>
												<div class="prd_price">
													...
													<div class="flex_box">
														<p class="price_result">17,000원</p>
													</div>
									...
									<div class="swiper-slide" data-swiper-column="2"
										...
										style="-webkit-box-ordinal-group: 6; order: 6; margin-top: 0px; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/bakery/19103"> <img
												class="prd_thumb_default"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/ML/KL/304_20221014153612185NA.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/ML/KL/304_20221014153612185NA.png"
												width="224" height="251" alt="" style="user-select: none;">
												<img class="prd_thumb_hover"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/SD/ZR/20221014153616890WF.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/SD/ZR/20221014153616890WF.png"
												width="224" height="251" alt="" style="user-select: none;">
											</a>
											<!-- 아이콘 클릭하면 prd_btn에 on 클래스 붙음 -->
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_cart_btn"
													title="장바구니" data-add-url="/kr/ko/shop/cart/add/19103"
													data-item-name="프리미엄 녹차와플" data-item-state="onsale"
													data-item-price="6000" data-is-purchase="true"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/bakery/19103">프리미엄 녹차와플</a>
												</p>
												<div class="prd_price">
									...
									<div class="swiper-slide" data-swiper-column="2"
										data-swiper-row="2"
										style="-webkit-box-ordinal-group: 10; order: 10; margin-top: 0px; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/teashop/15243"> <img
												class="prd_thumb_default"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/PK/MI/304_20240220144612891OC.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/PK/MI/304_20240220144612891OC.png"
												width="224" height="251" alt="" style="user-select: none;">
												<img class="prd_thumb_hover"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/GG/GR/20240220144616745JV.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/GG/GR/20240220144616745JV.png"
												width="224" height="251" alt="" style="user-select: none;">
											</a>
											<!-- 아이콘 클릭하면 prd_btn에 on 클래스 붙음 -->
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_cart_btn"
													title="장바구니" data-add-url="/kr/ko/shop/cart/add/15243"
													data-item-name="삼다 꿀배 티" data-item-state="onsale"
													data-item-price="9500" data-is-purchase="true"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/teashop/15243">삼다 꿀배 티</a>
												</p>
												<div class="prd_price">
									...
									<div class="swiper-slide" data-swiper-column="3"
										data-swiper-row="0"
										style="-webkit-box-ordinal-group: 3; order: 3; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/teashop/17583"> <img
												class="prd_thumb_default"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/LD/NM/304_20240531181453130RA.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/LD/NM/304_20240531181453130RA.png"
												width="224" height="251" alt="" style="user-select: none;">
												<img class="prd_thumb_hover"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/YC/GS/20240531181456631WE.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/YC/GS/20240531181456631WE.png"
												width="224" height="251" alt="" style="user-select: none;">
											</a>
											<!-- 아이콘 클릭하면 prd_btn에 on 클래스 붙음 -->
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_cart_btn"
													title="장바구니" data-add-url="/kr/ko/shop/cart/add/17583"
													data-item-name="[2024년 골든픽] 세작 80g"
													data-item-state="onsale" data-item-price="40000"
													data-is-purchase="true"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/teashop/17583">[2024년 골든픽] 세작
														80g</a>
												</p>
												<div class="prd_price">
									...
									<div class="swiper-slide" data-swiper-column="3"
										...
										style="-webkit-box-ordinal-group: 7; order: 7; margin-top: 0px; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/teashop/5661"> <img
												class="prd_thumb_default"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/JP/KO/304_20240220144420696EE.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/JP/KO/304_20240220144420696EE.png"
												width="224" height="251" alt="" style="user-select: none;">
												<img class="prd_thumb_hover"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/GF/PU/20240220144424378NJ.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/GF/PU/20240220144424378NJ.png"
												width="224" height="251" alt="" style="user-select: none;">
											</a>
											<!-- 아이콘 클릭하면 prd_btn에 on 클래스 붙음 -->
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_cart_btn"
													title="장바구니" data-add-url="/kr/ko/shop/cart/add/5661"
													data-item-name="제주 순수녹차" data-item-state="onsale"
													data-item-price="9500" data-is-purchase="true"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/teashop/5661">제주 순수녹차</a>
												</p>
												<div class="prd_price">
									...
									<div class="swiper-slide" data-swiper-column="3"
										data-swiper-row="2"
										style="-webkit-box-ordinal-group: 11; order: 11; margin-top: 0px; width: 893px;">
										<div class="prd_thumb">
											<a href="/kr/ko/shop/item/teashop/16646"> <img
												class="prd_thumb_default"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/NS/QP/304_20191007152144573YX.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/NS/QP/304_20191007152144573YX.png"
												width="224" height="251" alt="" style="user-select: none;">
												<img class="prd_thumb_hover"
												srcset="https://image.osulloc.com/upload/kr/ko/adminImage/XO/HL/20191016101651432HP.webp"
												src="https://image.osulloc.com/upload/kr/ko/adminImage/XO/HL/20191016101651432HP.png"
												width="224" height="251" alt="" style="user-select: none;">
											</a>
											<!-- 아이콘 클릭하면 prd_btn에 on 클래스 붙음 -->
											<div class="hover_icon">
												<button type="button" class="prd_btn prd_cart_btn"
													title="장바구니" data-add-url="/kr/ko/shop/cart/add/16646"
													data-item-name="덖음차 50g" data-item-state="onsale"
													data-item-price="15000" data-is-purchase="true"></button>
											</div>
										</div>
										<div class="prd_desc">
											<div class="prd_info">
												<p class="prd_name">
													<a href="/kr/ko/shop/item/teashop/16646">덖음차 50g</a>
												</p>
												<div class="prd_price">
													...
													<div class="flex_box">
														<p class="price_result">15,000원</p>
													</div>
		...
		<section class="main_sec w1200 secToday">
			<div class="todaySect">
				<div class="todayBg bgPc"
					style="background-image: url('https://image.osulloc.com/upload/kr/ko/adminImage/QW/SB/20240612182312973IS.jpg');">
					<!--오늘만이가격 pc-->
				</div>
				<div class="todayBg bgMo"
					style="background-image: url('https://image.osulloc.com/upload/kr/ko/adminImage/FV/KE/20240612182319445FV.jpg');">
					<!--오늘만이가격 mo-->
				</div>
				<a href="/kr/ko/shop/item/teashop/21672" ap-click-area="MAIN"
					ap-click-name="today only banner"
					...
					<div class="todayTxt">
						...
						<p class="todayDetail"></p>
						<!--오늘만이가격 원포인트-->
						<h4>[단독 구성] 골든픽 해차 세작 에디션 세트</h4>
						<div class="todayPrice">




							<div class="cost">32,000원</div>
							<div class="discount">20,800원</div>
							<div class="salePer">35%</div>
						</div>
					</div>
				</a>
			</div>
		...
		<!-- 출석체크, 스토리 : S -->
		<section class="main_sec w1200 secBanner">
			<div class="bannerFlex">
				<div class="BannerCheck">
					<a href="https://www.osulloc.com/kr/ko/life/event/view/12073">
						<img
						srcset="https://image.osulloc.com/upload/kr/ko/adminImage/XW/FT/20240528202258254PF.webp"
						src="https://image.osulloc.com/upload/kr/ko/adminImage/XW/FT/20240528202258254PF.jpg"
						loading="lazy" width="590" height="278" alt="6월 출석체크"
						style="user-select: none;">
						<div class="text_box">
							<p class="text01">6월 출석체크</p>
							<div class="date_info">
								<p class="text02">06.01 - 06.30</p>




								<span class="dday_tag">D-2</span>
				...
				<div class="BannerStory">
					<a href="/kr/ko/brandstory">
						<div class="img">
							<img
								srcset="https://image.osulloc.com/kr/ko/static_cdj/images/main/brand_story_img.webp"
								src="https://image.osulloc.com/kr/ko/static_cdj/images/main/brand_story_img.jpg"
								loading="lazy" width="590" height="278" alt="오설록 이야기"
								style="user-select: none;">
						</div>
						<div class="text_box">
							<p class="text01">TEA FROM JEJU</p>
							<p class="text02">오설록 스토리</p>
						</div>
					</a>
				</div>
			</div>
		...
		<section class="main_sec">
			<div class="main_store_banner">
				...
				<div class="main_banner_slider_wrap">
					<div
						class="main_banner_slider swiper-container-initialized swiper-container-horizontal">
						<ul class="swiper-wrapper"
							style="transition-duration: 0ms; transform: translate3d(-1199.57px, 0px, 0px);">
							<li class="swiper-slide swiper-slide-duplicate"
								style="width: 666.429px;" data-swiper-slide-index="6"><a
								href="/kr/ko/store-introduction/haeundae"
								class="btn_main_store_slider_banner"> <picture>
									<source
										srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_haeundae.webp"
										type="image/webp">
									<source
										srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_haeundae.jpg"
										type="image/jpg">
									<img
										data-src="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_haeundae.jpg"
										loading="lazy" width="373" height="392" alt="오설록 티하우스 해운대점"
										style="user-select: none;"> </picture>
									<div class="text_box_3">
										<h6 class="title ryu_gh_font">
											오설록 <br class="pcBlock">티하우스 <br class="moBlock">해운대점
										</h6>
										<p class="txt">
											차의 본질을 느끼며, <br>일상에서의 휴식을 완성하는 공간
										</p>
									</div>
							</a></li>
							<li class="swiper-slide swiper-slide-duplicate swiper-slide-prev"
								style="width: 666.429px;" data-swiper-slide-index="7"><a
								href="/kr/ko/store-introduction/gimpo"
								class="btn_main_store_slider_banner"> <picture>
									<source
										srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_gimpo.webp"
										type="image/webp">
									<source
										srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_gimpo.jpg"
										type="image/jpg">
									<img
										data-src="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_gimpo.jpg"
										loading="lazy" width="373" height="392" alt="오설록 티하우스 김포공항점"
										style="user-select: none;"> </picture>
									<div class="text_box_3">
										<h6 class="title ryu_gh_font">
											오설록 <br class="pcBlock">티하우스 <br class="moBlock">김포공항점
										</h6>
										<p class="txt">
											공항 내 여행객들에게 ‘휴식의 가치’와 <br>‘녹차 미식 경험’을 제공하는 공간
										</p>
									</div>
							</a></li>
							<li class="swiper-slide swiper-slide-active"
								style="width: 666.429px;" data-swiper-slide-index="0"><a
								href="/kr/ko/store-introduction/2"
								class="btn_main_store_slider_banner"> <picture>
									<source
										srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_jeju.webp"
										type="image/webp">
									<source
										srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_jeju.jpg"
										type="image/jpg">
									<img
										data-src="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_jeju.jpg"
										loading="lazy" width="373" height="392" alt="제주 오설록 티뮤지엄"
										style="user-select: none;"> </picture>
									<div class="text_box_3">
										<h6 class="title ryu_gh_font">
											제주 오설록 <br>티뮤지엄
										...
										<p class="txt">
											오설록의 역사를 간직하고 <br>차문화를 만들어가는 티 헤리티지 공간
										</p>
									</div>
							</a></li>
							<li class="swiper-slide swiper-slide-next"
								style="width: 666.429px;" data-swiper-slide-index="1"><a
								href="/kr/ko/store-introduction/312"
								class="btn_main_store_slider_banner"> <picture>
									<source
										srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_bukchon.webp"
										type="image/webp">
									<source
										srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_bukchon.jpg"
										type="image/jpg">
									<img
										data-src="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_bukchon.jpg"
										loading="lazy" width="373" height="392" alt="오설록 티하우스 북촌점"
										style="user-select: none;"> </picture>
									<div class="text_box_3">
										<h6 class="title ryu_gh_font">
											오설록<br>티하우스 북촌점
										...
										<p class="txt">
											오설록이 재해석한 60년대의 가옥에서<br>오설록의 취향과 <br class="moBlock">차문화를
											경험하는 공간
										</p>
									</div>
							</a></li>
							<li class="swiper-slide" style="width: 666.429px;"
								data-swiper-slide-index="2"><a
								href="/kr/ko/store-introduction/hannam"
								class="btn_main_store_slider_banner"> <picture>
									<source
										srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_hannam.webp"
										type="image/webp">
									<source
										srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_hannam.jpg"
										type="image/jpg">
									<img
										data-src="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_hannam.jpg"
										loading="lazy" width="373" height="392" alt="오설록 티하우스 한남점"
										style="user-select: none;"> </picture>
									<div class="text_box_3">
										<h6 class="title ryu_gh_font">
											오설록<br>티하우스 한남점
										...
										<p class="txt">
											오설록과 페이스갤러리의 협업으로 <br class="moBlock">탄생한 <br
												class="pcBlock">예술과 차 애호가를 위한 <br class="moBlock">차문화
											복합 공간
										</p>
									</div>
							</a></li>
							<li class="swiper-slide" style="width: 666.429px;"
								...
								href="/kr/ko/store-introduction/mmca"
								class="btn_main_store_slider_banner"> <picture>
									<source
										srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_mmca.webp"
										type="image/webp">
									<source
										srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_mmca.jpg"
										type="image/jpg">
									<img
										data-src="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_mmca.jpg"
										loading="lazy" width="373" height="392" alt="오설록 티하우스 MMCA"
										style="user-select: none;"> </picture>
									<div class="text_box_3">
										<h6 class="title ryu_gh_font">
											오설록<br>티하우스 MMCA
										...
										<p class="txt">
											차와 국립현대미술관 서울관의 <br>문화예술이 함께하는 <br class="moBlock">차문화
											발견의 공간
										</p>
									</div>
							</a></li>
							<li class="swiper-slide" style="width: 666.429px;"
								data-swiper-slide-index="4"><a
								href="/kr/ko/store-introduction/yongsan"
								class="btn_main_store_slider_banner"> <picture>
									<source
										srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_yongsan.webp"
										type="image/webp">
									<source
										srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_yongsan.jpg"
										type="image/jpg">
									<img
										data-src="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_yongsan.jpg"
										loading="lazy" width="373" height="392" alt="오설록 티하우스 용산파크점"
										style="user-select: none;"> </picture>
									<div class="text_box_3">
										<h6 class="title ryu_gh_font">
											오설록<br class="pcBlock">티하우스 <br class="moBlock">용산파크점
										</h6>
										<p class="txt">
											오설록 한정 메뉴와 APMA 전시를 <br>동시에 만날 수 있는 컨템포러리한 공간
										</p>
									</div>
							</a></li>
							<li class="swiper-slide" style="width: 666.429px;"
								data-swiper-slide-index="5"><a
								href="/kr/ko/store-introduction/174"
								class="btn_main_store_slider_banner"> <picture>
									<source
										srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_1979.webp"
										type="image/webp">
									<source
										srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_1979.jpg"
										type="image/jpg">
									<img
										data-src="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_1979.jpg"
										loading="lazy" width="373" height="392" alt="오설록 1979"
										style="user-select: none;"> </picture>
									<div class="text_box_3">
										<h6 class="title ryu_gh_font">
											오설록<br>1979
										...
										<p class="txt">
											오설록의 명차와 감도높은 찻자리를 <br>만날 수 있는 프리미엄 티룸
										</p>
									</div>
							</a></li>
							<li class="swiper-slide" style="width: 666.429px;"
								data-swiper-slide-index="6"><a
								href="/kr/ko/store-introduction/haeundae"
								class="btn_main_store_slider_banner"> <picture>
									<source
										srcset="https://image.osulloc.com/kr/ko/static_cdj/others/image/stdd/osl_stdd_main/main_th_haeundae.webp"
						...
						<div
							class="swiper-pagination main_slide_pagination swiper-pagination-bullets">
							<span
					...
					<div class="swiper-button-prev main_slide_prev" tabindex="0"
					...
					<div class="main_btn_typeA">
						...
						<button type="button" class="btn_A"
							onclick="javascript:location.href='/kr/ko/store-introduction'">


							<span>전체 매장 둘러보기</span>
						</button>
					</div>
				</div>
			</div>
		...
		<section class="main_sec">
			<div class="main_store_banner main_b2b_banner">
				...
				<div class="w1200 linkbox">
					<a href="https://osulloc.biz/" class="banner_link"> <img
						srcset="https://image.osulloc.com/kr/ko/static_cdj/images/main/b2b_banner.webp"
						data-src="https://image.osulloc.com/kr/ko/static_cdj/images/main/b2b_banner.jpg"
						loading="lazy" width="1200" height="350" class="pcBlock"
						alt="단체 및 기업 구매 페이지로 이동" style="user-select: none;"> <img
						srcset="https://image.osulloc.com/kr/ko/static_cdj/images/main/b2b_banner_m.webp"
						data-src="https://image.osulloc.com/kr/ko/static_cdj/images/main/b2b_banner_m.jpg"
						loading="lazy" width="375" height="280" class="moBlock"
						alt="단체 및 기업 구매 페이지로 이동" style="user-select: none;">
					</a>
				</div>
				<div class="w1200 btnbox main_btn_typeA">
					<button type="button" class="btn_A"
						onclick="javascript:location.href='https://osulloc.biz'">
						<span>바로 가기</span>
					</button>
				</div>
			</div>
...
.O_pop-wrapper .newUserPop .Footer button {
	...
	background:
		url("https://image.osulloc.com/kr/ko/static_cdj/images/etc/newUserPopClose.jpg")
		no-repeat center left/11px 11px;
}
</style>
			...
			<div class="inner1600 clearfix">
				<div class="right">
					...
					<a
						...
						alt="유튜브" style="user-select: none;">
						...
						alt="인스타그램" style="user-select: none;"> <img class="hide_pc"
						src="https://image.osulloc.com/kr/ko/static_renew/images/sns_i_m.png"
						alt="인스타그램" style="user-select: none;">
					</a>
				</div>
			...
			<div class="inner1600 clearfix">
				...
				<div class="right">
					<a href="https://www.osulloc.com/kr/ko/store-introduction"
						...
						alt="매장안내" style="user-select: none;"> <span>매장안내</span>
						...
						alt="멤버십혜택" style="user-select: none;"> <span>멤버십혜택</span>
						...
						alt="FAQ" style="user-select: none;"> <span>FAQ</span>
						...
						alt="단체 및 기업 구매" style="user-select: none;"> <span>단체
							및 <br>기업 구매
					</span>
						...
						alt="1:1문의" style="user-select: none;"> <span>1:1문의</span>
						...
						alt="뷰티포인트" style="user-select: none;"> <span>뷰티포인트<br>추후적립
					</span>
					</a>
				</div>
			</div>
			...
			<div class="inner1600 clearfix">
				<div class="logo logo_footer">
					<a href="https://www.osulloc.com/kr/ko/mypage/qna"
						...
						width="112" height="158" alt="1:1문의" style="user-select: none;"></a>
				</div>
				<div class="left">
					<div class="cont1">
						<ul>
				...
				<div class="right">
					<div class="box clearfix">
						...
						<img
							...
							alt="에스크로 가입사실확인" class="escrow_img" style="user-select: none;">
	...
	<div class="loading_wrap" style="display: none;">
		<div class="loading_inner">
			<img class="loading_gif"
				...
				alt="로딩이미지" style="user-select: none;">
		</div>
	</div>
	<script>
	/* 로딩 호출 함수 */
...
/*   require(['TweenMax'], function(a){
	...
	var nowdate = '1719559384953';
	var countYN = 'Y';
	var startAt = '1719500400000';
	var endAt = '1719586740059';
	...
	$(document).ready(function() {
		...
		if(countYN == "Y"){
			if(checksecond1 > 0 || checksecond2 < 0){
				$('#todayOnlyArea').html('00<span>:</span>00<span>:</span>00');
			}else{
		...
		function ShowCountDown(){
			...
			if(leftsecond > 0){
				...
				$('#todayOnlyArea').html(hour + '<span>:</span>' + minute + '<span>:</span>' + second);
	...
	function goPresent(ids, amount){
		...
		var currentPath = "https://www.osulloc.com/kr/ko";
...
function sendRequestFB(a){var b=!1;try{if("PageView"!=a.evt_name&&"InitiateCheckout"!=a.evt_name&&"CompleteRegistration"!=a.evt_name&&"ViewContent"!=a.evt_name&&"Search"!=a.evt_name&&"AddToCart"!=a.evt_name&&"Purchase"!=a.evt_name)return;a.event_source_url=window.location.href;a.action_source="website";Object.entries(a).map(function(c){return c.join("\x3d")}).join("\x26")}catch(c){}return b};</script>
	...
	<iframe allow="join-ad-interest-group" data-tagging-id="AW-645486124"
		data-load-time="1719559383547" height="0" width="0"
		src="https://td.doubleclick.net/td/rul/645486124?random=1719559383539&amp;cv=11&amp;fst=1719559383539&amp;fmt=3&amp;bg=ffffff&amp;guid=ON&amp;async=1&amp;gtm=45be46q0v9173972193za200&amp;gcd=13l3l3l3l1&amp;dma=0&amp;tag_exp=0&amp;u_w=1920&amp;u_h=1080&amp;url=https%3A%2F%2Fwww.osulloc.com%2Fkr%2Fko&amp;ref=https%3A%2F%2Fwww.osulloc.com%2Fkr%2Fko%2Fshop%2Fitem%2Flist%3Fcategory%3Dteashop%26line%3D198&amp;hn=www.googleadservices.com&amp;frm=0&amp;tiba=%EC%98%A4%EC%84%A4%EB%A1%9D%2C%20%EC%B0%A8%EC%99%80%20%EC%A0%9C%EC%A3%BC%EA%B0%80%20%EC%84%A0%EC%82%AC%ED%95%98%EB%8A%94%20%EA%B0%80%EC%B9%98%20%EC%9E%88%EB%8A%94%20%EC%89%BC%20%7C%20%EC%98%A4%EC%84%A4%EB%A1%9D&amp;npa=0&amp;pscdl=noapi&amp;auid=1024826354.1719211052&amp;uaa=x86&amp;uab=64&amp;uafvl=Not%252FA)Brand%3B8.0.0.0%7CChromium%3B126.0.6478.127%7CGoogle%2520Chrome%3B126.0.6478.127&amp;uamb=0&amp;uam=&amp;uap=Windows&amp;uapv=15.0.0&amp;uaw=0&amp;fledge=1&amp;data=event%3Dgtag.config"
...
try{if("APP"!=AP_DATA_CHANNEL){var mobionDevice="MOBILE"==AP_DATA_CHANNEL?"M":"W";(function(a,d,e,b,c){a.enp=a.enp||function(){(a.enp.q=a.enp.q||[]).push(arguments)};b=d.createElement(e);b.async=!0;b.defer=!0;b.src="https://cdn.megadata.co.kr/dist/prod/enp_tracker_self_hosted.min.js";c=d.getElementsByTagName(e)[0];c.parentNode.insertBefore(b,c)})(window,document,"script");enp("create","common","osulloc",{device:"B"});enp("send","common","osulloc")}}catch(a){};</script>
	...
	<div id="adn_container" style="display: none">
		<div id="adn_wrap_86788170489" style="display: none"></div>
	</div>
